    ...
    <HrLayout>
      <div className="flex flex-col gap-2 max-w-[1600px] mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-2.5">
          <StatCard icon={Users2} label="Total" value={employees.length} accent="#671421" />
          <StatCard icon={UserCheck} label="Present" value={counts.present} accent="#8B182C" />
          <StatCard icon={UserX} label="Absent" value={counts.absent} accent="#ef4444" />
          <StatCard icon={Home} label="WFH" value={counts.wfh} accent="#A76C76" />
          <StatCard icon={CalendarOff} label="On Leave" value={counts.onLeave} accent="#6E5F61" />
          <StatCard icon={Timer} label="Total Hours Today" value={formatHours(counts.totalHours)} accent="#360C13" />
        </div>
