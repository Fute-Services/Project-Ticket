...
export const assets = [
  {
    id: 'AST-1001', type: 'Laptop', model: 'Dell Latitude 5440', serialNo: 'SN-DL5440-9821', assignedTo: 'John Doe', department: 'Engineering', purchaseDate: '2024-02-11', warrantyEnd: '2027-02-11', status: 'In Use', approvalStatus: 'approved',
  ...
  {
    id: 'AST-1002', type: 'Laptop', model: 'MacBook Pro 14"', serialNo: 'SN-MBP14-3012', assignedTo: 'Priya Nair', department: 'Design', purchaseDate: '2025-06-03', warrantyEnd: '2028-06-03', status: 'In Use', approvalStatus: 'pending_founder',
  ...
  {
    id: 'AST-2001', type: 'Desktop', model: 'HP EliteDesk 800', serialNo: 'SN-HP800-4491', assignedTo: 'Jane Smith', department: 'Finance', purchaseDate: '2023-04-18', warrantyEnd: '2026-04-18', status: 'In Use', approvalStatus: 'none',
    hardDisk: '512GB SSD',
