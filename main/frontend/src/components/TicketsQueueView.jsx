...
export default function TicketsQueueView({ tickets, onStatusChange, onFieldChange, deptLabel = 'IT', showVpnNo = deptLabel === 'IT', showOnlyTitle = deptLabel === 'HR', approvals, showApprovalsColumn = Boolean(approvals) }) {
  const { user } = useAuth();
