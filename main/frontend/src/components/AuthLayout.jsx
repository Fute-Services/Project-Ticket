...
// stays on the light cherry-red theme. Overriding the token CSS variables here
...
export default function AuthLayout({ children }) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_75%_50%,_rgba(139,24,44,0.18)_0%,_rgba(54,12,19,0.12)_35%,_transparent_75%)] pointer-events-none" />
      ...
      <div className="hidden lg:flex w-[50%] h-full relative items-center justify-center overflow-hidden shrink-0 z-10">
        ...
        <div className="absolute right-[20%] top-[25%] w-[180px] h-[180px] bg-[#A76C76]/45 rounded-full blur-[45px] pointer-events-none animate-pulse z-0" />
        ...
        <div className="absolute right-[15%] bottom-[22%] w-[200px] h-[200px] bg-[#A76C76]/35 rounded-full blur-[55px] pointer-events-none animate-pulse z-0" />
        <div className="absolute right-[35%] bottom-[35%] w-[140px] h-[140px] bg-[#A76C76]/40 rounded-full blur-[40px] pointer-events-none z-0" />
        ...
        <div className="relative w-full h-full flex items-center justify-center p-2 z-10">
          <img
            ...
            className="w-[125%] max-w-none max-h-[94vh] object-contain transform scale-110 drop-shadow-[0_0_55px_rgba(139,24,44,0.85)] drop-shadow-[0_0_100px_rgba(167,108,118,0.65)] drop-shadow-[0_0_150px_rgba(103,20,33,0.45)] drop-shadow-[0_30px_70px_rgba(0,0,0,0.95)] brightness-110 contrast-105"
          />
        </div>
      </div>
    </div>
