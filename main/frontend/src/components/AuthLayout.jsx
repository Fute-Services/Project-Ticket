export default function AuthLayout({ children }) {
  return (
    <div className="h-screen w-screen max-h-screen bg-background text-foreground flex flex-col lg:flex-row overflow-hidden font-sans relative">
      ...
      <div className="hidden lg:block absolute right-[10%] top-1/2 -translate-y-1/2 w-[550px] h-[550px] bg-warning/15 rounded-full blur-[130px] pointer-events-none animate-pulse" />
      ...
      <div className="hidden lg:flex w-[50%] h-full relative items-center justify-center overflow-hidden shrink-0 z-10">
        ...
        <div className="absolute right-[20%] top-[25%] w-[180px] h-[180px] bg-warning/45 rounded-full blur-[45px] pointer-events-none animate-pulse z-0" />
        ...
        <div className="absolute right-[15%] bottom-[22%] w-[200px] h-[200px] bg-warning/35 rounded-full blur-[55px] pointer-events-none animate-pulse z-0" />
        <div className="absolute right-[35%] bottom-[35%] w-[140px] h-[140px] bg-warning/40 rounded-full blur-[40px] pointer-events-none z-0" />
