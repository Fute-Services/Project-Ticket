...
export default function FounderAiAdvisorView({ onNavigate }) {
  ...
  const agents = {
    ...
    it: {
      ...
      color: 'border-cyan-500/30 text-cyan-400 bg-cyan-950/20 shadow-cyan-500/5',
      accent: '#06b6d4',
      icon: Cpu,
    },
    coordinator: {
      ...
      color: 'border-purple-500/30 text-purple-400 bg-purple-950/20 shadow-purple-500/5',
      accent: '#a855f7',
      icon: FolderKanban,
    },
    employee: {
  ...
  return (
    <div className="w-full flex flex-col gap-6 relative">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-card border border-border rounded-2xl p-5 shadow-lg relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-80 h-full bg-gradient-to-l from-primary/5 via-purple-500/5 to-transparent pointer-events-none" />
        
        <div className="flex items-start gap-4">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-tr from-primary to-purple-600 flex items-center justify-center text-white shadow-lg border border-primary/20 shrink-0">
